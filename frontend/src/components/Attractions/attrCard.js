...
export class Item extends Component {
  ...
  render() {
    let {title, imageURL, hotelURL, reviews, rating, reviewURL, latitude, longitude, ranking_subcategory, address, subcategory} = this.props;
      ...
      <div>
            <div className="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div className="px-6 py-4">
                    ...
                    <p className="text-gray-700 text-base">
                        <strong>{ranking_subcategory}</strong>
                    </p>
                    <br/>
                    <p className="text-gray-700 text-base">
