...
const Detail01 = () => {
  ...
  return (
    <header className='w-screen h-screen relative bg-slate-900'>
      {/* <video
        src={bgVideo}
...
<br></br>
        ...
        >
          ...
          <div className='flex justify-center mb-3'>
            <input type="date" placeholder="yyyy-mm-dd" className='bg-slate-800 rounded-xl text-white pl-5 pr-3 pb-1' name="StartDate" onChange={hadleStartDate}/>
            <p className='mx-4 mt-2 pb-2'>To</p>
            <input type="date" placeholder="yyyy-mm-dd" className='bg-slate-800 rounded-xl text-white pl-5 pr-3 pb-1' name="StartDate" onChange={hadleEndDate}/>
          </div>
