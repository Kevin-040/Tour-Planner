    ...
    <><div class="container my-24 px-6 mx-auto">
          ...
          <section class="mb-32 text-gray-800">
              ...
              <div class="container text-gray-800 px-4 md:px-12">
                ...
                ease-in-out
                m-0
                focus:text-gray-700 focus:bg-white focus:border-slate-700 focus:outline-none" id="exampleInput7" placeholder="Name" />
                                  </div>
                                  <div class="form-group mb-6">
                ...
                ease-in-out
                m-0
                focus:text-gray-700 focus:bg-white focus:border-slate-700 focus:outline-none" id="exampleInput8" placeholder="Email address" />
                                  </div>
                                  <div class="form-group mb-6">
                                      <textarea class="
                form-control
              ...
              " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                                  ...
                                  <div class="form-group form-check text-center mb-6">
                                      <input type="checkbox" class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-slate-700 checked:border-slate-700 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer" id="exampleCheck87" checked />
                              ...
                              <div class="flex flex-wrap">
                                  <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                      <div class="flex items-start">
                                          <div class="shrink-0">
                                              <div class="p-4 bg-slate-700 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                                          ...
                                          <div class="grow ml-6">
                                              ...
                                              <p class="text-gray-500">kevinconcept550@gmail.com</p>
                                  ...
                                  <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                      <div class="flex items-start">
                                          ...
                                          <div class="grow ml-6">
                                              ...
                                              <p class="text-gray-500">bt123@gmail.in</p>
                                              <p class="text-gray-500">+1 234-567-89</p>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                      <div class="flex align-start">
                                          ...
                                          <div class="grow ml-6">
                                              ...
                                              <p class="text-gray-500">yashmevada14@gmail.com</p>
                                              <p class="text-gray-500">+1 234-567-89</p>
                                          </div>
                                      </div>
                                  </div>
                                  <div class="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                      <div class="flex align-start">
                                          ...
                                          <div class="grow ml-6">
                                              ...
                                              <p class="text-gray-500">kavajay98@gmail.com</p>
                                              <p class="text-gray-500">+1 234-567-89</p>
                                          </div>
                                      </div>
                                  </div>
